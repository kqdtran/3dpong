...
var paddle1DirY = 0, paddle2DirY = 0, paddleSpeed = 4.5;

// ball variables
var BALLSPEED = 3;
var ball, paddle1, paddle2;
var ballDirX = 1, ballDirY = 1, ballSpeed = BALLSPEED;
...
function ballPhysics()
{
	...
	// limit ball's y-speed to 1.5x the x-speed
...
{
	// if player reaches the max score
	if (score1 >= maxScore)
	{
		// stop the ball
		ballSpeed = 0;
		// write to the banner
		$("#scores").html("You win with the score " + score1 + "-" + score2 + "!");
		$("#winnerBoard").html("To play again, refresh or press ");
		$("#winnerBoard").append('<input type="button" class="btn-custom" value="here" onClick="history.go(0)">')
	}
	// else if reaches the max score
	else if (score2 >= maxScore)
	{
		// stop the ball
		ballSpeed = 0;
		// write to the banner
		$("#scores").html("CPU wins with the score " + score2 + "-" + score1 + "!");
		$("#winnerBoard").html("To play again, refresh or press ");
		$("#winnerBoard").append('<input type="button" class="btn-custom" value="here" onClick="history.go(0)">')
	}
}